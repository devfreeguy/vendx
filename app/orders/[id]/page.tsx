...
export default function OrderPage() {
  ...
  if (!order)
    return (
      <div className="min-h-screen flex flex-col relative overflow-hidden">
        <HeroBackground />
        <Header />
        <div className="flex-1 flex justify-center items-center text-muted-foreground relative z-10">
          Order not found
        </div>
        <Footer />
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      <HeroBackground />
      <Header />
      <main className="min-h-dvh flex flex-1 pt-24 pb-12 container mx-auto px-4 max-w-3xl items-center justify-center relative z-10">
        <Card className="w-full text-center py-8 border-border/60 shadow-md backdrop-blur-sm bg-card/80">
          <CardHeader>
            ...
            {order.status === "PENDING" && (
              <>
                {!order.paymentDetected ? (
                  ...
                  <div className="text-amber-600 flex flex-col items-center gap-4 py-8 animate-in fade-in zoom-in duration-300">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg mt-4 max-w-sm text-center">
                      <p className="text-xs text-muted-foreground">
                        Your payment has been seen on the network. Please wait
                        while it gets confirmed. This usually takes a few
                        minutes.
                      </p>
                    </div>
                  </div>
